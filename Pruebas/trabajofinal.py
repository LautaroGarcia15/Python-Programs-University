    ...
    try:
        with open('historial.txt', 'a', encoding='utf-8') as archivo:
            for registro in registro:
                ...
                archivo.write(f"{nombre};{correctas};{dificultad};{tiempo}\n")
...
try:
    with open('historial.txt', 'r', encoding='utf-8') as historial:
        for linea in historial:
            ...
            print("EL HISTORIAL DE JUGADORES: ")
            print(f"Nombre: {datos[0]}, Correctas: {datos[1]}, Dificultad: {datos[2]}, Tiempo: {datos[3]}")
except FileNotFoundError:
